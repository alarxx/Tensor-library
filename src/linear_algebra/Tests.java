...
import lib.linear_algebra.operations.MatMul;
import lib.linear_algebra.operations.Transposition;
import lib.linear_algebra.operations.elementary.Sum;
...
public class Tests {
    ...
    private static void castToDimsTest(){
        ...
        Tensor t = castToDims(tensor, 2, 3, 3);
    ...
    public static void upTheRankTest(){
        ...
        Tensor d3d = upTheRank(mat, 3, true);
